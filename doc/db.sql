...
CREATE TABLE `t_orders` (
  ...
  `f_ordermoney` decimal(19,4) unsigned NOT NULL DEFAULT '0.0000' COMMENT '订单金额',
  `f_deliverymoney` decimal(19,4) unsigned NOT NULL DEFAULT '0.0000' COMMENT '配送费',
  ...
  `f_servicemoney` decimal(19,4) unsigned NOT NULL DEFAULT '0.0000' COMMENT '服务费（仅食堂订单有）',
