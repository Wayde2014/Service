...
class DineshopModel extends Model
{
    ...
    public function modDineshopStatus($shopid, $status){
        ...
        try{
            ...
            if($status == 100){
                //审核通过则同步到前端表
                $shopinfo = Db::table('t_admin_dineshop')->field('f_shopname,f_shopdesc,f_shopicon,f_shophone,f_address,f_cuisineid,f_maplon,f_maplat,f_sales,f_deliveryfee,f_minprice,f_minconsume,f_preconsume,f_isbooking,f_opentime,f_isaway')->where('f_sid', $shopid)->find();
    ...
    public function getDineshopInfo($shopid){
        $dineshopinfo = Db::table('t_admin_dineshop')
            ->alias('a')
            ->field('a.f_sid id, a.f_adduser userid, a.f_shopname shopname, a.f_status status, a.f_shopdesc shopdesc, a.f_shopicon shopicon, a.f_shophone shophone, a.f_address address, a.f_cuisineid cuisineid, b.f_cname cuisinename, a.f_menulist menulist, a.f_maplon maplon, a.f_maplat maplat, a.f_sales sales, a.f_deliveryfee deliveryfee, a.f_minprice minprice,a.f_minconsume minconsume, a.f_preconsume preconsume, a.f_isbooking isbooking, a.f_opentime opentime, a.f_isaway isaway, a.f_deliverytime deliverytime, a.f_addtime addtime')
